...
public class PaperTest {
    ...
    public void testWhoWinsAgainstLizard() {
        ...
        String result = paper.whoWins(lizard);
        assertEquals("Lizard win Paper. You lose!", result);
    ...
    public void testWhoWinsAgainstSpock() {
        ...
        String result = paper.whoWins(spock);
        assertEquals("Paper win Spock. You win!", result);
